...
weights_filepath = 'maxf_smp_30train_30develop_weights.epoch:{epoch:02d}-val_acc:{val_acc:.2f}.hdf5'
...
y_test = np_utils.to_categorical(y_test, 30) # 必须使用固定格式表示标签
y_train = np_utils.to_categorical(y_train, 30) # 必须使用固定格式表示标签 一共 42分类
...
# model_b = load_model('maxf_smp_30train_30develop_weights.epoch:78-val_acc:0.63.hdf5')
#读取已经训练好的模型
