...
x_train = np.load('3_train_test_x_train_kf.npy')
x_test = np.load('3_train_test_x_test_kf.npy')
y_train = np.load('3_train_test_y_train_kf.npy')
y_test = np.load('3_train_test_y_test_kf.npy')
