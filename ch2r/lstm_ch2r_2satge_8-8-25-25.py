...
# #============================== 阶段1 判断 “定义” 与 “未定义” =============================
model_1 = load_model('maxf_ch2r_8train_8split_1develop_weights.epoch:189-val_acc:0.87.hdf5')
...
np.save('next_stage_8.npy',next_stage)
np.save('predict_class_8.npy',predict_class_1)
...
next_stage = np.load('next_stage_8.npy')
predict_class_1 = np.load('predict_class_8.npy')
