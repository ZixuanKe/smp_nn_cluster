...
n_folds = 5
n_classes = 26
weights_filepath = 'maxf_ch2r_' + str(n_classes) + 'train_' + str(n_classes) + 'develop_weights.epoch:{epoch:02d}-val_acc:{val_acc:.2f}.hdf5'
...
for i in range(n_folds):
    ...
    np.save(str(i) + '_train_test_x_train_kf.npy',split_0)
    np.save(str(i) + '_train_test_x_test_kf.npy',split_1)
    np.save(str(i) + '_train_test_y_train_kf.npy',split_2)
    np.save(str(i) + '_train_test_y_test_kf.npy',split_3)
