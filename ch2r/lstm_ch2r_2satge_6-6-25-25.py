...
# #============================== 阶段1 判断 “定义” 与 “未定义” =============================
model_1 = load_model('maxf_ch2r_6train_6split_1develop_weights.epoch:30-val_acc:0.89.hdf5')

predict_class_1 = model_1.predict_classes(x_test_1,batch_size=batch_size)

print predict_class_1
np.savetxt('predict_class_1.txt',predict_class_1)
np.savetxt('y_test.txt',y_test_1)
...
np.save('next_stage_6.npy',next_stage)
np.save('predict_class_6.npy',predict_class_1)
...
next_stage = np.load('next_stage_6.npy')
predict_class_1 = np.load('predict_class_6.npy')
