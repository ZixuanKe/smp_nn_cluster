...
# #============================== 阶段1 判断 “定义” 与 “未定义” =============================
# model_1 = load_model('maxf_ch2r_5train_5split_1develop_weights.epoch:18-val_acc:0.85.hdf5')
...
#
# np.save('next_stage_5.npy',next_stage)
# np.save('predict_class_5.npy',predict_class_1)
...
next_stage = np.load('next_stage_5.npy')
predict_class_1 = np.load('predict_class_5.npy')
